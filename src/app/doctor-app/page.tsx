...
export default function DoctorAppPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-5 bg-gradient-to-br from-brand-blue/90 via-brand-purple/90 to-blue-900 font-sans relative overflow-hidden">
            {/* Background Blobs */}
            <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-brand-purple/30 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-brand-blue/30 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 md:p-12 rounded-3xl shadow-2xl max-w-[420px] w-full text-center animate-in fade-in zoom-in-95 duration-500 relative z-10">
                ...
                <span className="block text-blue-50/80 text-base mb-8 leading-relaxed font-medium">
                    The ultimate platform for modern healthcare professionals. Connect,
                    consult, and care.
                </span>
