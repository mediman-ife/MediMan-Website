            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              <div className="flex flex-col space-y-8 text-center lg:text-left">
                ...
                <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-6xl xl:text-7xl leading-[1.1]">
                  Healthcare. <span className="text-brand-blue">Simplified.</span>
                </h1>
              ...
              <div className="relative mx-auto w-full max-w-[500px] lg:max-w-none">
                ...
                <div className="absolute bottom-32 -right-2 md:-right-6 z-20 glass-card p-4 rounded-xl animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-700 hidden md:block">
                  <div className="flex items-center gap-3">
                    <div className="bg-blue-100 p-2 rounded-lg text-brand-blue"><FileText className="w-5 h-5" /></div>
                    <div>
        ...
        <section className="py-16 relative overflow-hidden">
          ...
          <div className="container-width">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-slate-50 rounded-3xl p-8 md:p-12 relative overflow-hidden group hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div className="relative z-10 flex flex-col h-full justify-between space-y-6">
                  <div className="space-y-4">
                    <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-brand-blue shadow-sm group-hover:scale-110 transition-transform"><Video className="w-6 h-6" /></div>
                  ...
                  <Button variant="link" className="w-fit p-0 h-auto text-brand-blue font-semibold group-hover:translate-x-1 transition-transform">
              ...
              {/* Tall Card */}
              <div className="bg-brand-blue text-white rounded-3xl p-8 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                <div className="relative z-10 space-y-6">
                  ...
                  <p className="text-blue-100">Medical care doesn't wait for office hours. Find available doctors anytime, anywhere.</p>
                </div>
              ...
              {/* Small Card 1 */}
              <div className="bg-white rounded-3xl p-8 border border-slate-200 hover:border-brand-blue/30 hover:shadow-lg transition-all duration-300 group">
                <div className="space-y-4">
                  <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-brand-blue group-hover:rotate-6 transition-transform"><FileText className="w-6 h-6" /></div>
              ...
              <div className="bg-white rounded-3xl p-8 border border-slate-200 hover:border-brand-blue/30 hover:shadow-lg transition-all duration-300 group">
                <div className="space-y-4">
                  <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center text-purple-600 group-hover:rotate-6 transition-transform"><Users className="w-6 h-6" /></div>
          ...
          <div className="container-width">
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-12 relative z-10">
                {/* Step 1 */}
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center relative group hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-16 h-16 bg-brand-blue text-white rounded-2xl flex items-center justify-center text-2xl font-bold mx-auto mb-6 shadow-lg shadow-brand-blue/30 group-hover:scale-110 transition-transform">1</div>
                  <h3 className="text-xl font-bold text-slate-900 mb-3">Download & Sign Up</h3>
                  <p className="text-slate-600">Get the MediMan app from your store and create your secure profile in seconds.</p>
                </div>

                {/* Step 2 */}
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center relative group hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-16 h-16 bg-white border-2 border-brand-blue text-brand-blue rounded-2xl flex items-center justify-center text-2xl font-bold mx-auto mb-6 shadow-sm group-hover:bg-brand-blue group-hover:text-white transition-colors">2</div>
                  <h3 className="text-xl font-bold text-slate-900 mb-3">Choose Specialist</h3>
                  <p className="text-slate-600">Browse verified doctors, check reviews, and book a slot that works for you.</p>
                </div>

                {/* Step 3 */}
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center relative group hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-16 h-16 bg-white border-2 border-brand-blue text-brand-blue rounded-2xl flex items-center justify-center text-2xl font-bold mx-auto mb-6 shadow-sm group-hover:bg-brand-blue group-hover:text-white transition-colors">3</div>
                  <h3 className="text-xl font-bold text-slate-900 mb-3">Consult & Heal</h3>
                  <p className="text-slate-600">Join the video call, discuss your health, and get your digital prescription instantly.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container-width">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <span className="text-brand-blue font-bold tracking-wider text-sm uppercase bg-blue-50 px-3 py-1 rounded-full">Global Access</span>
                <h2 className="text-3xl md:text-5xl font-bold text-slate-900 leading-tight">
                  Care without borders. <br /><span className="text-brand-blue">For everyone.</span>
                </h2>
                ...
                <div className="space-y-4 text-slate-600">
                  ...
                  <ul className="space-y-3 pt-2">
                    ...
                    <li className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center text-brand-blue"><Video className="w-4 h-4" /></div>
                      <span>Video/Audio and secure e-prescriptions.</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-purple-100 flex items-center justify-center text-purple-600"><Clock className="w-4 h-4" /></div>
                ...
                <div className="pt-6">
                  <Link href="https://play.google.com/store/apps/details?id=com.mediman.life" target="_blank">
                    <Button size="lg" className="h-12 px-8 bg-brand-blue hover:bg-brand-dark text-white rounded-full text-base font-semibold shadow-lg shadow-brand-blue/20 transition-all hover:scale-105">
                      Download Now
                    </Button>
                  </Link>
                </div>
          ...
          <div className="container-width">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                <h2 className="text-3xl md:text-5xl font-bold text-slate-900 leading-tight">Loved by users <span className="text-brand-blue">across the globe.</span></h2>
              ...
              <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16 lg:gap-24">
                ...
                <div className="flex-1 relative w-full flex justify-center md:justify-end">
                  <div className="relative z-10">
                    <div className="absolute inset-0 bg-blue-500/30 blur-[60px] rounded-full scale-90 pointer-events-none"></div>
                    <Image
