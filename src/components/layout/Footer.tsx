...
import { Facebook, Twitter, Instagram, Linkedin, Mail, Phone, MapPin, Youtube, HelpCircle, MessageCircle, FileText, Stethoscope } from 'lucide-react';
                    ...
                    <div className="space-y-6 text-center lg:text-left">
                        ...
                        <div className="flex flex-col gap-3 items-center lg:items-start">
                            <a href="https://play.google.com/store/apps/details?id=com.mediman.doctor" target="_blank" className="hover:opacity-90 transition-opacity w-fit bg-white/5 p-1 rounded-lg border border-white/10 hover:bg-white/10">
                                <img src="/images/google-play.png" alt="Google Play" className="w-[200px] sm:w-auto sm:h-10" />
                            </a>
                            <a href="https://apps.apple.com/us/app/mediman-doctor/id6445903387" target="_blank" className="hover:opacity-90 transition-opacity w-fit bg-white/5 p-1 rounded-lg border border-white/10 hover:bg-white/10">
                                <img src="/images/app-store.png" alt="App Store" className="w-[200px] sm:w-auto sm:h-10" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-slate-950 border-t border-slate-800 py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
                    ...
                    <div className="flex flex-wrap items-center gap-4 justify-center">
                        <a href="https://www.producthunt.com/products/mediman?utm_source=badge-follow&utm_medium=badge&utm_source=badge-mediman" target="_blank" rel="noopener noreferrer" className="hover:opacity-90 transition-opacity">
                            <img src="https://api.producthunt.com/widgets/embed-image/v1/follow.svg?product_id=1150139&theme=dark" alt="MediMan - Healthcare. Anytime. Anywhere. | Product Hunt" className="h-11 w-auto" width="250" height="54" />
                        </a>
                        <a href='https://www.saashub.com/mediman?utm_source=badge&utm_campaign=badge&utm_content=mediman&badge_variant=color&badge_kind=approved' target='_blank' rel="noopener noreferrer" className="hover:opacity-90 transition-opacity">
                            <img src="https://cdn-b.saashub.com/img/badges/approved-color.png?v=1" alt="MediMan.life badge" className="h-11 w-auto" />
                        </a>
                    </div>
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
    return (
        <Link href={href} className="hover:text-brand-blue hover:translate-x-1 transition-all duration-200 w-fit flex items-center gap-2">
            {children}
        </Link>
    );
}
